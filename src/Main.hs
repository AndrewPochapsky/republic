...
generateIronCitizensWithProfession startingConfiguration (professionValue, percent) = generateCitizens startingConfiguration (ironPercent startingConfiguration * percent) (const Iron {age = 0, profession = professionValue})
